...
Manage* manage = NULL;
string sample_path = "/media/silence/Documents/OSDS/trace_sample.csv";
string traces_path = "/media/silence/Documents/OSDS/trace/1KB/traces";
string update_sample_path = "/media/silence/Documents/OSDS/update/1KB/sample";
string update_iops_path = "/media/silence/Documents/OSDS/update/1KB/iops";
string update_trace_path = "/media/silence/Documents/OSDS/update/1KB/trace";
string update_repair_path = "/media/silence/Documents/OSDS/update/1KB/repair";
string update_hybrid_path = "/media/silence/Documents/OSDS/update/1KB/hybrid";
string config_path = "/media/silence/Documents/OSDS";
    ...
    if(ifs.is_open()) {
        ...
        for (int i = 0; i < traces.size(); ++i) {
            if(traces[i].type == "Write") {
                char* data = new char[traces[i].length];
                cout << "=============进行第" << i + 1 << "次更新==============" << endl;
                string file_name = update_repair_path + "/" + filename + ".dir/" + to_string(i + 1) + ".updataData.bin";
                createUpdateData(data, traces[i].length, file_name);
                manage->write(data, traces[i].offset, traces[i].length);
                cout << "=======================================" << endl;
                delete [] data;
