...
void DABRI::writeData(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
    TSCNS ts;
    ts.init();
...
void DABRI::writeParity(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
...
void DABRI::readData(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
...
void DABRI::readParity(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
...
void DABRI::degrade_read(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
    // 采用日志重播的方式恢复dr
    Request req(request);
    req.from_id = request.to_id;
...
void DABRI::mergeData(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
    char * temp = new char[setting->part];
...
void DABRI::mergeParity(Response &_return, const Request &request, Buffer* buffer, Setting* setting) {
    char* dr = new char[setting->part];
    char* d0 = new char[setting->part];
